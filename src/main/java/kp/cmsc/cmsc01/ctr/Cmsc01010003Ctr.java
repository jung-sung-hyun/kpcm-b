...
@Tag(
        name       = "Cmsc01020000Ctr[관리자]게시판수정",
        description=  "===================================================================</br>"
...
@RestController
@WebAppConfiguration
@RequestMapping(value = "/cm/cmsc01010003")
public class Cmsc01010003Ctr {
    ...
    @ResponseBody
//    @PostMapping(value = "/update00")
    @RequestMapping(value = "/update00", method = RequestMethod.POST)
    public Map<String, Object> update00(@RequestBody Cmsc01010003Vo inputVo, @ParameterObject Cmsc01010003Vo swaggerParam) throws Exception {
        return cmsc01010003Svc.update00(inputVo);
    }
}
