...
@WebAppConfiguration
@Tag(
        name       = "Cmsc00000000Ctr[관리자]관리자 프로그램 공통관리",
        description=  "===================================================================</br>"
                + " @Package    : kp.cmsc.cmsc00.ctr                  </br>"
...
public class Cmsc00000000Ctr {
    @Resource
    private Cmsc00000000Svc cmsc00000000Svc;
    ...
    @Operation(
            ...
            description= "==================================================================================================================</br>"
                    ...
                    + "=====================================================================================================================</br>",
            parameters = {
                    @Parameter(name= "title"   , description= "-IN" , hidden= true,required = true)
            },
            responses = {
...
//    @PostMapping(value = "/selectList00")
    ...
    public Map<String, Object>  selectBoardList(@RequestBody Cmsc00000000Vo inputVo, @ParameterObject Cmsc01010000Vo swaggerParam) throws Exception {
        return cmsc00000000Svc.selectList00(inputVo);
    }
